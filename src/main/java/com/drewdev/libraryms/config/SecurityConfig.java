package com.drewdev.libraryms.config;
...
import com.drewdev.libraryms.filter.AuthorizationFilter;
...
public class SecurityConfig {
	...
	@Bean
	public AuthenticationManager authManager(HttpSecurity http, UsersService userService, BCryptPasswordEncoder encoder)
			throws Exception {
